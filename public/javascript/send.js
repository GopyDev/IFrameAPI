$(document).ready(function () {
    $('#original_url').on('input', function () {
        ...
        $('#iframe_code').val('<iframe src="https://www.youtube.com/embed/' + url.substr(32) + '?modestbranding=0;&controls=0;&showinfo=0;&rel=0" frameborder="0" allowfullscreen="allowfullscreen"></iframe');
